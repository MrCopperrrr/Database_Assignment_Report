\section{Assignment 1}
    \subsection*{1. Phân tích và mô tả yêu cầu dữ liệu cho chủ đề đã chọn}
    \addcontentsline{toc}{section}{1. Phân tích và mô tả yêu cầu dữ liệu cho chủ đề đã chọn}
    
    %========================================================================================
    \subsubsection*{1.1. Tìm hiểu ứng dụng/hệ thống tham khảo}
    ...
    %========================================================================================
    \newpage
    \subsubsection*{1.2. Mô tả hệ thống đề xuất}
    ...
    %========================================================================================
    \subsubsection*{1.3. Các ràng buộc ngữ nghĩa không thể hiện trực tiếp trên (E-)ERD}
